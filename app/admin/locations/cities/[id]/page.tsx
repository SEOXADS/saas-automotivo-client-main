...
import { Building2, Edit, ArrowLeft, Trash2, Home } from 'lucide-react'
...
export default function CityShowPage() {
  ...
  const handleDelete = async () => {
    ...
    const confirmed = confirm(`Tem certeza que deseja excluir a cidade "${city.name}"?`)
    if (!confirmed) return
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            ...
            <p className="text-red-700 mb-4">
              A cidade que você está procurando não foi encontrada ou não existe mais.
            </p>
            <Button
  ...
  return (
    <AdminLayout title={city.name} subtitle="Detalhes da cidade">
      <div className="container mx-auto px-4 py-8">
          ...
          <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="p-3 bg-gray-50 border border-gray-200 rounded-md text-sm">
                    {new Date(city.created_at).toLocaleString('pt-BR')}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="p-3 bg-gray-50 border border-gray-200 rounded-md text-sm">
                    {new Date(city.updated_at).toLocaleString('pt-BR')}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mt-6">
              ...
              <div className="space-y-3">
                <Button
                  onClick={() => router.push(`/admin/locations/neighborhoods/create?city_id=${city.id}`)}
                  variant="outline"
                ...
                <Button
                  onClick={() => router.push(`/admin/locations/neighborhoods?city_id=${city.id}`)}
                  variant="outline"
                  className="w-full justify-start"
                  icon={<Home className="w-4 h-4" />}
                >
