...
export default function PortalLayout({
  ...
  {/* Facebook */}
  <a 
    href="https://www.facebook.com/omegaveiculoscomendadoroetterer" 
    target="_blank" 
  ...
  {/* Instagram */}
  <a 
    href="https://www.instagram.com/omegaveiculoscomendador/" 
    target="_blank" 
    rel="noopener noreferrer" 
    className="text-black hover:text-orange-500 transition-colors" 
  ...
  {/* LinkedIn */}
  <a 
    href="https://www.linkedin.com/company/omega-veiculos-sorocaba" 
    target="_blank" 
    rel="noopener noreferrer" 
    className="text-black hover:text-orange-500 transition-colors" 
  ...
  {/* Google Meu Negócio */}
  <a 
    href="https://g.page/r/CShYdEQOlPsPEAE/review" 
    target="_blank" 
    rel="noopener noreferrer" 
    className="text-black hover:text-orange-500 transition-colors" 
    title="Avalie-nos no Google"
  >
    <span className="sr-only">Google Meu Negócio</span>
    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {/* YouTube */}
  <a 
    href="https://www.youtube.com/@omegaveiculos" 
    target="_blank" 
    rel="noopener noreferrer" 
    className="text-black hover:text-orange-500 transition-colors" 
